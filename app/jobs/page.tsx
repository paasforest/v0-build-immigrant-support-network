...
const jobsData = {
  poland: {
    ...
    jobs: [
      ...
      {
        id: "pl-hotel-1",
        title: "Hotel restaurant — waiter / waitress (Kudowa Zdrój)",
        type: "Hospitality",
        location: "Kudowa Zdrój, Poland",
        salary: "33.78 PLN gross/h (~24.40 net) — employer rates",
        duration: "Stable employment — employer (mandate contract)",
        requirements: [
          "Communicative English — minimum B1 level (employer)",
          "Accuracy (employer)",
          "Commitment to work (employer)",
          "Availability (employer)",
          "Good manners (employer)",
          "Minimum 1 year of experience in a 3- or 4-star hotel (employer)",
          "Valid passport and any permits required for lawful work in Poland",
        ],
        description:
          "Waiter / waitress role at a major hotel in Kudowa Zdrój. We assist your application as a recruitment agency; the employer hires and pays you.",
        bodyParagraphs: [
          "Immigrant Support Network is a recruitment agency: we help candidates apply to third-party employers. We are not the hiring company, we do not sign your work contract ourselves, and we do not pay your wages. The summary below reflects information supplied by the employer for this vacancy.",
          "For our client, one of the largest hotels in Kudowa Zdrój, we are recruiting a waiter / waitress.",
          "Your responsibilities will include: comprehensive guest service; serving meals; keeping the restaurant clean; preparing receipts for customers.",
        ],
        employerOfferBullets: [
      ...
      {
        id: "pl-wh-1",
        title: "Warehouse worker — 30 vacancies (Mazowieckie voivodeship)",
        type: "Warehouse",
        location: "Mazowieckie voivodeship, Poland",
        salary: "31.40 PLN gross/h (~22.68 net) — employer rates",
        duration: "Up to ~200 h/month; 5–6 days/week (employer indicative)",
        requirements: [
          "No visa sponsorship — employer does not sponsor visas; you need existing right to work or your own visa route",
          "At least 1 year of experience as a warehouse worker (employer)",
          "Willingness to work long hours (employer)",
          "Willingness to work in a warehouse environment (employer)",
        ...
        description:
          "Warehouse roles with a logistics and distribution employer in Mazowieckie. We assist your application as a recruitment agency; the employer hires and pays you.",
        bodyParagraphs: [
          "Immigrant Support Network is a recruitment agency: we help candidates apply to third-party employers. We are not the hiring company, we do not sign your work contract ourselves, and we do not pay your wages. The summary below reflects information supplied by the employer for this vacancy.",
          "For our client, a logistics and distribution company, we are looking for 30 warehouse workers. The employer states that they do not offer visa sponsorship.",
          "The job includes: receiving deliveries; unloading and organizing goods in the warehouse; labeling products; maintaining order at the workplace. Work is performed in a dynamic environment with day or night shifts, depending on assignment.",
        ],
        employerOfferBullets: [
          "Employment based on a contract of mandate (umowa zlecenie) (employer)",
          "31.40 PLN gross per hour (~22.68 PLN net per hour) (employer)",
          "Accommodation and transportation fee (VAN transfers): 600–700 PLN per month (employer)",
          "Two shifts — day 8:00–18:00, night 20:00–6:00; fixed schedule (day or night only) (employer)",
          "Typically 5–6 days per week (employer)",
          "Salary paid on the 15th day of each month (employer)",
          "Possibility of working up to 200 hours per month (employer)",
          "Work clothes provided by the employer (employer)",
        ],
        imageUrl:
