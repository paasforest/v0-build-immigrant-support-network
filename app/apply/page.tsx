          ...
          <div className="bg-[#111111] p-8 md:p-12 rounded-lg border-2 border-gold">
            <div className="text-center mb-8">
              ...
              <p className="text-white/70">
                Your application has been sent via WhatsApp. To complete your registration, please pay the application fee below.
              </p>
            </div>

            {/* Payment Details */}
            <div className="bg-[#0a0a0a] border border-gold/30 rounded-lg p-6 mb-8">
              <h3 className="text-lg font-semibold text-gold mb-4 text-center">
                Registration Fee: R300
              </h3>
              <div className="space-y-3 text-white/80 text-sm">
                <div className="flex justify-between border-b border-[#2a2a2a] pb-2">
                  <span className="text-white/60">Bank:</span>
                  <span className="font-medium">FNB (First National Bank)</span>
                </div>
                <div className="flex justify-between border-b border-[#2a2a2a] pb-2">
                  <span className="text-white/60">Account Name:</span>
                  <span className="font-medium">Immigrant Support Network</span>
                </div>
                <div className="flex justify-between border-b border-[#2a2a2a] pb-2">
                  <span className="text-white/60">Account Number:</span>
                  <span className="font-medium">62XXXXXXXX</span>
                </div>
                <div className="flex justify-between border-b border-[#2a2a2a] pb-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-gold">Your Full Name</span>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://wa.me/27774388845?text=Hi%2C%20I%20just%20submitted%20my%20application%20and%20made%20payment.%20Here%20is%20my%20proof%20of%20payment."
                target="_blank"
      ...
      <section className="py-16 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto">
            Complete the form below to start your journey towards working abroad. 
