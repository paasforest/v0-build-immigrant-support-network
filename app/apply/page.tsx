    ...
    return (
      <section className="min-h-[80vh] flex items-center justify-center py-20 bg-[#0a0a0a]">
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#111111] p-8 md:p-12 rounded-lg border-2 border-gold text-center">
            ...
            <p className="text-white/70 mb-6">
              Our team will contact you shortly. You may refer others to get priority processing.
            </p>
